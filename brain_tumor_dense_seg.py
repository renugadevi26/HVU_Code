...
callbacks = [
    ModelCheckpoint("/nfsshare/knr/knrtrain/renu/dense_vit/brain_tumor_vit_res_weights.h5", verbose=1, save_best_only=True, monitor='val_loss', mode='min', save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=5, min_lr=1e-7, verbose=1),
    CSVLogger("/nfsshare/knr/knrtrain/renu/dense_vit/brain_tumor_vit_res_csv.log"),
]
