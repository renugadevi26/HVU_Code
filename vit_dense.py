...
def build_unet(input_shape):
    ...
    layer_to_keep = base_model.layers[-116].output
...
callbacks = [
    ModelCheckpoint('/nfsshare/knr/knrtrain/renu/figshare/vit_dense/vit_dense.weights10.h5', verbose=1, save_best_only=True, monitor='val_loss', mode='min', save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=5, min_lr=1e-7, verbose=1),
    CSVLogger('/nfsshare/knr/knrtrain/renu/figshare/vit_dense/vit_dense10.csv')
]
unet_model.fit(imgs,lb,epochs=10,validation_split=0.2,batch_size=32,callbacks=callbacks)
unet_model.save('/nfsshare/knr/knrtrain/renu/figshare/vit_dense/vit_dense_complete_model.h5')