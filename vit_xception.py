...
def build_unet(input_shape):
    ...
    layer_to_keep = base_model.layers[-11].output
...
callbacks = [
    ModelCheckpoint('/nfsshare/knr/knrtrain/renu/figshare/vit_xception/vit_xception.weights.h5', verbose=1, save_best_only=True, monitor='val_loss', mode='min', save_weights_only=True),
    ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=5, min_lr=1e-7, verbose=1),
    CSVLogger('/nfsshare/knr/knrtrain/renu/figshare/vit_xception/vit_xception.csv')
